...
while True:
    while count <= 1000:                                    # parity=1
        ...
        p_matrix_corrupted = burst.BE_generate_burst(p_matrix, 0, len(p_matrix)-1, random.randint(0, 4))
        msg_corrupted = burst.BE_msg_matrix_text(p_matrix_corrupted)
        #print_matrix(p_matrix_corrupted)
