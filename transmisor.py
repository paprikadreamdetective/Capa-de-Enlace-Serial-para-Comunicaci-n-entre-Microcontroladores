...
while (True):
    while (count < 1000):
        ...
        oled.show()
        p_matrix = errorDetection.BE_msg_matrix(message)
        p_matrix_corrupted = errorDetection.BE_generate_burst(p_matrix, 3, 6, random.randint(0, 4))
        msg_corrupted = errorDetection.BE_msg_matrix_text(p_matrix_corrupted)
